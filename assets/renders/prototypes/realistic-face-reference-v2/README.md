...
It was generated from the approved project-owned
`../realistic-model-v1/modeling-turnaround.png` with that cub's identity,
anatomy, age, coat, standing pose, and studio lighting fixed as invariants.

Why this checkpoint exists:

- the former neutral mesh blended four planar textures over incompatible head
  geometry, stretching or duplicating eyes, muzzle, and ear markings;
- stronger blending, approximate symmetry, replacement primitives, and direct

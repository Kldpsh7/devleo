# Leo the Dev — realistic v2

Approved production graphics for the photorealistic young lion-cub identity.

- Atlas: Codex v2, 8 columns × 11 rows, 192 × 208 cells.
- Final size: 1536 × 2288 RGBA WebP.
- Standard rows: idle, directional pounce, wave, jump, failure, waiting,
  active work, and review.
...
The logo-free silver laptop is state-dependent: closed while moving/jumping,
half-open while waiting, and fully open while working/reviewing.
